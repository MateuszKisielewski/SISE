...
$Progcmd = 'java --module-path "C:\Users\Krzysztof Kata\Desktop\javafx\lib" --add-modules javafx.controls,javafx.graphics -jar "C:\Users\Krzysztof Kata\Desktop\puzzleval.jar"'
